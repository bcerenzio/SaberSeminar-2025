...
#### 2024 ####
baseballsavant_2024 <- download_baseballsavant('2024-03-15', '2024-10-15', cl = clusters)


baseballsavant_2024 <- baseballsavant_2024 %>% 
  select(-half_inning, -spin_dir, -spin_rate_deprecated, -tfs_deprecated, -tfs_zulu_deprecated,
         -break_angle_deprecated, -break_length_deprecated, -umpire, -sv_id) %>% 
  rename(
    'game_pk' = 'game_id',
    'game_year' = 'year',
...
write_csv(baseballsavant_2024 %>% 
            mutate(across(everything(), ~as.character(.))) %>% 
            mutate(across(everything(), ~replace_na(., 'NULL'))), 'statcast2024.csv')

remove(baseballsavant_2024)

#### 2023 ####
baseballsavant <- download_baseballsavant('2023-03-15', '2023-10-15', cl = clusters)
...
write_csv(baseballsavant %>% 
            mutate(across(everything(), ~as.character(.))) %>% 
            mutate(across(everything(), ~replace_na(., 'NULL'))), 'statcast.csv')

remove(baseballsavant)


### 2022 ####
baseballsavant <- download_baseballsavant('2022-03-15', '2022-10-15', cl = clusters)
...
### 2021 ####
baseballsavant <- download_baseballsavant('2021-03-15', '2021-10-15', cl = clusters)
...
### 2020 ####
baseballsavant <- download_baseballsavant('2020-03-15', '2020-10-15', cl = clusters)
...
### 2019 ####
baseballsavant <- download_baseballsavant('2019-03-15', '2019-10-15', cl = clusters)
...
### 2018 ####
baseballsavant <- download_baseballsavant('2018-03-15', '2018-10-15', cl = clusters)
...
### 2017 ####
baseballsavant <- download_baseballsavant('2017-03-15', '2017-10-15', cl = clusters)
...
### 2016 ####
baseballsavant <- download_baseballsavant('2016-03-15', '2016-10-15', cl = clusters)
...
### 2015 ####
baseballsavant <- download_baseballsavant('2015-03-15', '2015-10-15', cl = clusters)
